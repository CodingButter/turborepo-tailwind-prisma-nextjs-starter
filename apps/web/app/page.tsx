	...
	const features = [
		{
			...
			description:
				'Connect to Twitch channels and chat in real-time with full IRC support',
		...
		},
		{
			...
			description:
				'Play interactive games that integrate with your Twitch chat',
				...
				<div className="container mx-auto px-4 relative z-10">
					<div className="text-center max-w-3xl mx-auto">
						...
						<p className="text-xl text-text-secondary mb-10 leading-relaxed">
							Connect to Twitch, chat with your community, and play interactive
			...
			<section className="py-16 bg-background-secondary">
				<div className="container mx-auto px-4 text-center">
					...
					<p className="text-xl text-text-secondary mb-8 max-w-2xl mx-auto">
						Join the fun today and connect with your favorite Twitch
						communities.
					</p>
					<Link
						href="/chat"
			...
			<footer className="py-8 bg-background-tertiary border-t border-border">
				<div className="container mx-auto px-4">
					...
					<div className="mt-8 pt-6 border-t border-border text-center text-text-tertiary text-sm">
						&copy; {new Date().getFullYear()} Twitch Chat Interactive. All
						rights reserved.
					</div>
				</div>
			</footer>
